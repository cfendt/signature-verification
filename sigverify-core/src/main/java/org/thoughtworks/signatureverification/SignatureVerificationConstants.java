...
public interface SignatureVerificationConstants {
    ...
    public static String SECOND_TEMPLATE_SIGNATURE = "sig2";
    public static String SECOND_TEMPLATE_SIGNATURE_NORM = "sig2Norm";
    public static String SECOND_TEMPLATE_SIGNATURE_NORM_DIGEST = "sig2NormDigest";
    public static String TEST_TEMPLATE_SIGNATURE = "sigTest";
    public static String TEST_TEMPLATE_SIGNATURE_NORM = "sigTestNorm";
